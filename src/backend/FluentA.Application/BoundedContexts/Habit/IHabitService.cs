...
public interface IHabitService
{
    ...
    Task<OperationResult<IReadOnlyList<HabitDto>>> ListAsync(Guid userId, string? timeZoneId, CancellationToken cancellationToken = default);
    ...
    /// <summary>Gets learner-local statistics for one owned habit.</summary>
    Task<OperationResult<HabitStatsDto>> GetStatsAsync(Guid userId, Guid habitId, string? timeZoneId, CancellationToken cancellationToken = default);
