...
public sealed class ProjectCard : BaseEntity
{
    private ProjectCard()
    {
        Title = string.Empty;
    ...
    public static ProjectCard Create(
        Guid columnId,
        string title,
        string? description,
        CardPriority priority,
        ...
        int sortOrder)
    {
        return new ProjectCard(columnId, title, description, priority, deadline, sortOrder);
    }
    ...
    private static string CleanTitle(string title)
    {
        ...
        {
            throw new ArgumentException("Project card title must be between 1 and 240 characters.", nameof(title));
        }
    ...
    private static string? CleanDescription(string? description)
    {
        ...
        {
            throw new ArgumentException("Project card description must be at most 4000 characters.", nameof(description));
        }
