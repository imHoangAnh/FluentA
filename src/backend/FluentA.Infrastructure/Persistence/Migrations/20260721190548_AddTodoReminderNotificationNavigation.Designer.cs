...
namespace FluentA.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260721190548_AddTodoReminderNotificationNavigation")]
    partial class AddTodoReminderNotificationNavigation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FluentA.Domain.BoundedContexts.Todo.Entities.TodoItem", b =>
                {
                    ...
                    b.Property<Guid?>("GeneratedFromTodoId")
                        .HasColumnType("uuid")
                        .HasColumnName("generated_from_todo_id");

                    b.Property<bool>("IsCompleted")
                        .HasColumnType("boolean")
                        .HasColumnName("is_completed");

                    b.Property<bool>("IsGeneratedOccurrencePristine")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                    ...
                    b.Property<DateTime?>("ReminderScheduledAtUtc")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<string>("ReminderTimeZoneId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("reminder_time_zone_id");
            ...
            modelBuilder.Entity("FluentA.Domain.BoundedContexts.Todo.Entities.TodoItem", b =>
                {
                    b.HasOne("FluentA.Domain.BoundedContexts.Todo.Entities.TodoItem", null)
                        .WithMany()
