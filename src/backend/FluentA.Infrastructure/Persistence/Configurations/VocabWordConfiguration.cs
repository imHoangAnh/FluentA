...
public sealed class VocabWordConfiguration : IEntityTypeConfiguration<VocabWord>
{
    public void Configure(EntityTypeBuilder<VocabWord> builder)
    {
        ...
        builder.Property(word => word.MeaningEn).HasColumnName("meaning_en").HasMaxLength(2000).IsRequired();
        ...
        builder.Property(word => word.Thesaurus).HasColumnName("thesaurus").HasMaxLength(2000);
        builder.Property(word => word.Collocation).HasColumnName("collocation").HasMaxLength(2000);
