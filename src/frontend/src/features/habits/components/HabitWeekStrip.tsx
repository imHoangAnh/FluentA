...
export function HabitWeekStrip({
  ...
  return (
    <section className="habit-tracker-week" aria-label="Select a habit date">
      <div className="habit-week-strip-container">
        <button type="button" className="habit-week-nav-btn" onClick={onPrevious} aria-label="Previous week">
          <ChevronLeft size={16} />
        </button>
        ...
        <button type="button" className="habit-week-nav-btn" onClick={onNext} aria-label="Next week">
