...
export type ReviewSessionWord = { wordId: string; word: string; wordClass: string; meaningVn: string; meaningEn: string; example: string; thesaurus?: string | null; collocation?: string | null; note?: string | null; mode: ReviewMode | Exclude<ReviewMode, 'random'> }
