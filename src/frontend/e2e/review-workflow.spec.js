...
async function mockReviewApis(page) {
  await page.route('**/api/v1/**', async (route) => {
    ...
    if (path.endsWith('/flashcards/pages')) return json([{ boardId: 'board-1', boardName: 'Review board', boardLanguage: 'en', pages: [{ pageId: 'page-1', pageName: 'Deck', isPracticed: false, words: [{ id: 'card-1', wordId: 'word-1', word: 'alpha', wordClass: 'other', meaningVn: 'alpha vn', meaningEn: 'alpha definition', example: 'alpha example', isInReview: true, nextReviewDate: '2026-07-13T00:00:00Z', lapseCount: 0 }, { id: 'card-2', wordId: 'word-2', word: 'beta', wordClass: 'other', meaningVn: 'beta vn', meaningEn: 'beta definition', example: 'beta example', isInReview: true, nextReviewDate: '2026-07-12T00:00:00Z', lapseCount: 0 }] }] }])
    ...
    if (path.endsWith('/review')) return json({ wordId: 'word-1', result: 'correct', reviewHistoryId: 'history-1', levelBefore: 0, levelAfter: 1, lapseCount: 0, nextReviewDate: '2026-07-15T00:00:00Z' })
