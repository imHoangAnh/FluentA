...
notifications, the read-only deck viewer, and Page Deck Active Recall. All
Words Normal/Shuffle SM-2 review is also supported. Spaced due queues,
dashboards, settings, and daily planning are separate stories.
...
Cards copy the word, class, Vietnamese meaning, English meaning, example,
...
- Sessions support Normal or Shuffle order, front/answer reveal, best-effort
  automatic and manual TTS, progress, and mouse or keyboard controls.
...
- Completed sessions show an immediate rating summary. Session order, progress,
  timing, and summary are ephemeral and are discarded when the route is left.

## All Words SM-2 Review

- Learners can start Normal or Shuffle sessions from a non-empty All Words
  Deck. Spaced mode remains deferred.
